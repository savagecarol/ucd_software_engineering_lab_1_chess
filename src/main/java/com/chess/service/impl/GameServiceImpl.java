...
import com.chess.service.ScoringService;
import com.chess.storage.GameStorage;
import com.chess.storage.PlayerStorage;
...
public class GameServiceImpl implements GameService {
    ...
    public void playGame(Game game) {
        ...
        while (!game.isFinished()) {
            ...
            if (game.isWhiteInCheck() && game.getCurrentTurn() == com.chess.enums.ColourEnum.WHITE) {
                System.out.println(" ⚠ White is in check!");
            }
            if (game.isBlackInCheck() && game.getCurrentTurn() == com.chess.enums.ColourEnum.BLACK) {
